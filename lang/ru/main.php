...
return [
    ...
    'operation' => 'операция',
    'external_id' => 'уникальный идентификатор',
    ...
    'receipt' => [
        ...
        'company' => [
            ...
            'inn' => 'ИНН организации',
            'payment_address' => 'адрес расчетов',
            'payment_site' => 'место расчетов',
        ],
    ...
    'notification' => [
        ...
        'intro' => 'Ваш электронный кассовый чек.',
        'view_receipt' => 'Чек в ОФД',
        'sms' => 'Кассовый чек на сумму :total руб.',
    ],
