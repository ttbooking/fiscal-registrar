...
class ReceiptStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'operation' => ['sometimes', 'nullable', 'string', Rule::enum(Enums\Operation::class)],
            ...
            'payload.company.tax_system' => ['sometimes', 'nullable', 'string', Rule::enum(Enums\TaxSystem::class)],
            ...
            'payload.agent_info.type' => ['required_with:payload.agent_info', 'string', Rule::enum(Enums\AgentType::class)],
            ...
            'payload.vats.vat22' => 'sometimes|numeric|between:0,99999999.99',
            ...
            'payload.vats.vat122' => 'sometimes|numeric|between:0,99999999.99',
    ...
    public function attributes(): array
    {
        return [
            ...
            'payload.vats.vat22' => __('fiscal-registrar::main.receipt.vats.vat22'),
            ...
            'payload.vats.vat122' => __('fiscal-registrar::main.receipt.vats.vat122'),
